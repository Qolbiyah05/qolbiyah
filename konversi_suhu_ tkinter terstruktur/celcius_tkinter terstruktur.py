...
def get_fahrenheit():
    suhu = txtsuhu.get()
    F = (9/5) * (float(suhu)) + 32
    txtFahrenhait.delete(0, END)
    txtFahrenhait.insert(END, C)
...
# Output Textbox
txtFahrenhait = Entry(frame)
txtFahrenhait.grid(row=3, column=1, sticky=W, padx=5, pady=5)
