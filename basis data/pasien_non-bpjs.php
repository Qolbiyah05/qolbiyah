...
// Query untuk mengambil data dari tabel pasien non bpjs
...
<head>
    ...
    <title>Data Pasien Non BPJS</title>
...
<body>
    ...
    <div class="container mt-5">
        <h1 class="text-center">Data Pasien Non BPJS</h1>
        ...
        <form class="d-flex mb-3" method="GET">
            <input type="text" name="search" class="form-control me-2" placeholder="Cari nama atau NIK" 
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
            ...
            <td>
                ...
                <!-- Button Delete -->
                <a href='delete.php?id=" . urlencode($row['id']) . "&jenis=Non-BPJS' class='btn btn-danger btn-sm' 
