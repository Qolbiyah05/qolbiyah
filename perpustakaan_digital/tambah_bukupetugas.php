...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['foto']['name'])) {
        ...
        if (in_array($file_extension, $allowed_types)) {
            if (move_uploaded_file($_FILES["foto"]["tmp_name"], $foto_path)) {
                ...
                echo "<script>alert('Gagal mengunggah gambar.'location : kelola_bukupetugas.php );</script>";
            }
        } else {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Buku berhasil ditambahkan!'); window.location='kelola_bukupetugas.php';</script>";
    } else {
