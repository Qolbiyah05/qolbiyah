...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <!-- Form Pencarian -->
            <form action="kelola_buku.php" method="get" class="mb-3">
                ...
                <tbody>
                    <?php while ($buku = $result->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_buku.php?id=<?= $buku['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="hapus_buku.php?id=<?= $buku['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
